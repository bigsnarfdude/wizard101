...
```bibtex
@software{wizard101_cascade,
  title = {Safety Cascade: Multi-tier AI Safety Guardrails},
  author = {bigsnarfdude},
  year = {2025},
...
Areas of interest:
- **Benchmarking**: Additional adversarial datasets
- **Optimization**: Speed improvements for L1/L2
- **Multilingual**: Non-English safety classification
- **Documentation**: Tutorials and guides

---

**Built for safety. Designed for speed. Made for production.**

```bash
cd experiments/cascade
python evaluate_cascade_batch.py --samples 100
```
