#!/usr/bin/env python3
"""Experiment 09: Baseline model + Verbose policies"""
...
serial_gauntlet_simple.load_policies = load_policies_09
...
def patched_check(content, policy_name, policy_text, model_param="gpt-oss:20b"):
    return _original_check(content, policy_name, policy_text, "gpt-oss:20b")
...
if __name__ == '__main__':
    ...
    sys.argv = ['experiment_09.py', 'wildguard_benchmark.json']
    run_eval()
