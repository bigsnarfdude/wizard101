#!/usr/bin/env python3
"""Experiment 08: Baseline model + Medium policies"""
...
serial_gauntlet_simple.load_policies = load_policies_08
...
if __name__ == '__main__':
    ...
    sys.argv = ['experiment_08.py', 'wildguard_benchmark.json']
    run_eval()
